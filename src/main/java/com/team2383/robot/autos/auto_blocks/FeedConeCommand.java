...
public class FeedConeCommand extends SequentialCommandGroup {
    public FeedConeCommand(ElevatorSubsystem elevator, WristSubsystem wrist, FeederSubsystem feeder) {
        addCommands(
