...
public class FeedCubeCommand extends SequentialCommandGroup {
    public FeedCubeCommand(ElevatorSubsystem elevator, WristSubsystem wrist, FeederSubsystem feeder) {
        addCommands(
                new BlizzardCommand(elevator, wrist, BlizzardPresets.GROUND_INTAKE),
                new FeederVoltageCommand(feeder, () -> -0.5, true));
    }
}
